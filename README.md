...
**Answer: the logistic regression model, has predicted healthy loans '0' at 100% both on recal and precision. On the the unhealthy loans '1', the moel has predicted 87% on precision and 89% on recall.Thus making this a strong model.

Question: How well does the logistic regression model, fit with oversampled data, predict both the 0 (healthy loan) and 1 (high-risk loan) labels?

**Answer:The Logistic Refgression Model fits the oversampled well, as it improved recall to 100% on both sides, which for a senario as this one, recall would be the right choice by indicating true positives.
